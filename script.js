function tala() {
  ...
  ScrollTrigger.scrollerProxy("#bg", {
    ...
    pinType: document.querySelector("#bg").style.transform
      ? "transform"
      : "fixed",
  });
...
bar.addEventListener("click", function (e) {
  if (flag === 0) {
    document.querySelector("#nav-bar").style.filter =
      "invert(0%) sepia(00%) saturate(6481%) hue-rotate(246deg) brightness(0%) contrast(143%)";
    ...
    document.querySelector("#nav-bar").style.filter =
      "brightness(2) sepia(1) hue-rotate(-70deg) saturate(5)";
